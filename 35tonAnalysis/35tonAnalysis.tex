...
\begin{figure}
  ...
  \caption{Extraction of the true value of $\Delta z$ from the full distribution of measured $z$-offsets.  A measured value of $0.118\pm0.007$~cm is found.}
...
%  \resizebox*{\columnwidth}{!}{
    \begin{tabular}{l  c  c  c  c }
      ...
      \midrule
      Initial $z$-offset (cm) & $-0.61 \pm 0.04$   & $0.15 \pm 0.01$    & $0.55 \pm 0.06$    & $0.118 \pm 0.007$  \\ %\hline
      $x$-offset (cm)         & $-0.364 \pm 0.007$ & $-0.254 \pm 0.002$ & $-0.16 \pm 0.01$   & $-0.286 \pm 0.002$ \\ %\hline
      $z$-offset (cm)         & $-0.62 \pm 0.02$   & $0.131 \pm 0.007$  & $0.56 \pm 0.03$    & $0.102 \pm 0.004$  \\
      \bottomrule
    \end{tabular}
 % }
  \vspace{3cm}
 ...
 % \resizebox*{\columnwidth}{!}{
    \begin{tabular}{l  c  c  c  c }
      ...
      \midrule
      TPC1/TPC3 $x$-gap & 0 & $-0.364 \pm 0.007$ & $-0.364 \pm 0.007$ \\
      TPC1/TPC5 $x$-gap & 0 & $-0.254 \pm 0.002$ & $-0.254 \pm 0.002$ \\
      TPC3/TPC7 $x$-gap & 0 & $-0.16 \pm 0.01$   & $-0.16 \pm 0.01$   \\
      TPC5/TPC7 $x$-gap & 0 & $-0.286 \pm 0.002$ & $-0.286 \pm 0.002$ \\
      \midrule
      TPC1/(3)/TPC7 $x$-gap & 0 & $-0.52 \pm 0.01$   & $-0.52 \pm 0.01$   \\
      TPC1/(5)/TPC7 $x$-gap & 0 & $-0.540 \pm 0.003$ & $-0.540 \pm 0.003$ \\
      \midrule
      TPC1/TPC3 $z$-gap & 2.53 & $-0.62 \pm 0.02$  & $1.91 \pm 0.02$   \\
      TPC1/TPC5 $z$-gap & 2.08 & $0.131 \pm 0.007$ & $2.211 \pm 0.007$ \\
      TPC3/TPC7 $z$-gap & 1.63 & $0.56 \pm 0.03$   & $2.19 \pm 0.03$   \\
      TPC5/TPC7 $z$-gap & 2.08 & $0.102 \pm 0.004$ & $2.182 \pm 0.004$ \\
      \midrule
      TPC1/(3)/TPC7 $z$-gap & 4.16 & $-0.06 \pm 0.04$ & $4.10 \pm 0.04$ \\
      TPC1/(5)/TPC7 $z$-gap & 4.16 & $0.233 \pm 0.01$ & $4.39 \pm 0.01$ \\
      \bottomrule
    \end{tabular}
  %}
\end{table}
...
\begin{figure}
  \centering
  \includegraphics[width=10cm]{evd_run14249_subrun1_event4492.png}%evd_t0_2.pdf}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\textwidth]{CorrectedPlaneGap.eps}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\textwidth]{CorrectedDrift.eps}
